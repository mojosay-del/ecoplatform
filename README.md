...
- Pre-MVP-модули (форум, торговая площадка, магазин решений) заведены в enum'ах и
  сайдбаре, но без UI — это сделано осознанно как «фундамент на вырост», чтобы не
  двигать позже миграции с реальными платежами на проде.
