...
audit/               отчёты аудита, план волн, PROGRESS-журнал, Lighthouse baseline
...
- Pre-MVP-модули (форум, торговая площадка, магазин решений) уже отмечены в enum'ах и сайдбаре, но без UI — это сделано осознанно как «фундамент на вырост», чтобы не двигать миграции с реальными платежами на проде позже. Описание подхода — в `audit/EXECUTION-PLAN.md` (Волна 7).
