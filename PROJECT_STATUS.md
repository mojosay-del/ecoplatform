...
Волна 12 — CMS-полишинг и админ-таблицы — закрыта полностью. Текущий следующий блок по audit — Волна 13: финал MVP.
...
Целевой следующий шаг: Волна 13.1 — контент для двух MVP-курсов.
...
- **Волна 13** — финал MVP: контент 2 курсов, чистка постMVP-модулей из публичной выдачи, prod smoke, bug-bash, пользовательская документация и проверка бэкапов.
