...
Целевой следующий шаг: Волна 12.1 — админ-листинги перевести в компактные таблицы с сортировкой и фильтр-баром.
...
- **Волна 12** — CMS-полишинг и админ-таблицы: компактные таблицы, скрытие cuid, локализация enum-значений, breadcrumbs, CMS preview, drag-and-drop, auto-save, preview «как видит пользователь», admin dashboard.
