...
// сырья: макулатура — МКР/МКЛ, а также МС (марки стандарта макулатуры по ГОСТ:
// МС-5Б, МС-6Б, …, МС-13В); плёнки — ПЛН; пластики — ПЛС; прочее → «default».
...
const CODE_PREFIX_MATERIALS: Array<{ prefixes: string[]; material: NomenclatureMaterial }> = [
  { prefixes: ["МКР", "МКЛ", "МС"], material: { slug: "makulatura", label: "Макулатура" } },
