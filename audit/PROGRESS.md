...
- **Текущая волна:** 9 — Безопасность и 152-ФЗ, 8/11 закрыто.
- **Открытые задачи:** 9.7 (audit-trail before/after), 9.10 (password policy + haveibeenpwned), 9.11 (документ политики безопасности).
